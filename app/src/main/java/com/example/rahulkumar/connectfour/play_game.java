...
public class play_game extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        board1 = new board(NUM_COLS, NUM_ROWS);
    ...
    private void drop(int col) {
        ...
        board1.fillCell(col, row);
        if (board1.checkWin(col, row)) {
            win();
        } else {
            changeTurn();
        }
    ...
    private void win() {
        //int color = board1.turn == board.Turn.FIRST ? getResources().getColor(R.color.primary_player) : getResources().getColor(R.color.secondary_player);
        viewHolder.winnerText.setTextColor(R.drawable.board_bg);
